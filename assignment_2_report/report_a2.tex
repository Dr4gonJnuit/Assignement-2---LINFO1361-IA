...
\begin{answers}[8cm]
      ...
      \hline
      \textbf{a} & -$\infty$, -12, 0, 1 & +$\infty$ \\ %TODO Insert your answer in the table (example: \textbf{a} & 1, 3, 2 & 5, 4 \\)
...
\textbf{Cuts:} 14, 23, 31, 43%TODO Insert your answer here (example: 2, 4, 6, 8, 10)
\end{answers}
...
\begin{answers}[8cm]
      ...
      Node & $\alpha$ values & $\beta$ values\\
      \hline
      \textbf{a} & -$\infty$, 1 & +$\infty$ \\ %TODO Insert your answer in the table (example: \textbf{a} & 1, 3, 2 & 5, 4 \\)
      \textbf{b} & 1 & +$\infty$ \\
      \textbf{c} & 1 & +$\infty$ \\
...
\textbf{Cuts:} 4, 5, 7, 34, 35 %TODO Insert your answer here (example: 2, 4, 6, 8, 10)
\end{answers}
